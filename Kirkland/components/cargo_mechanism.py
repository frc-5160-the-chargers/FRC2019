...
class CargoRotator:
    ...
    def execute(self):
        if self.enabled:
            motor_power = clamp(self.power, -robotmap.Tuning.CargoMechanism.Rotator.lowering_power_limit, robotmap.Tuning.CargoMechanism.Rotator.lifting_power_limit)
...
class CargoMechanism:
    rotator : CargoRotator
    locking_servo : CargoServo
